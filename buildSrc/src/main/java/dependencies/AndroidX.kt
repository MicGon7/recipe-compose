...
object AndroidX {
    ...
    const val nav_ui_ktx = "androidx.navigation:navigation-ui-ktx:${Versions.navigation_component}"
    ...
    const val accompanist_coil =
        "dev.chrisbanes.accompanist:accompanist-coil:${Versions.accompanist_coil}"
